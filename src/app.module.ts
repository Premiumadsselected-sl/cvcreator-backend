...
import { TefPayNotificationsModule } from "./payments/tefpay/notifications/notifications.module";
...
@Module({
  imports: [
    ...
    TefPayNotificationsModule, // Módulo para notificaciones de TefPay.
